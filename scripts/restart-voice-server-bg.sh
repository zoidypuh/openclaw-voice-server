...
LOG_FILE="${AGENTIC_SWITCHBOARD_LOG_FILE:-/tmp/agentic-switchboard.log}"
setsid "$PYTHON_BIN" -m agentic_switchboard.app >"$LOG_FILE" 2>&1 </dev/null &

echo "agentic-switchboard restarted in background"
echo "pid: $!"
echo "log: $LOG_FILE"
