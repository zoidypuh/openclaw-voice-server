...
ENV_TO_CONFIG = {
    ...
    "MARAS_SWITCHBOARD_HERMES_SESSION_ID": ("agent", "hermes_session_id"),
    "MARAS_SWITCHBOARD_HERMES_API_MODEL": ("agent", "hermes_api_model"),
    "MARAS_SWITCHBOARD_HERMES_DELEGATE_API_MODEL": ("agent", "delegate_api_model"),
    "MARAS_SWITCHBOARD_HERMES_DELEGATE_TOOLSETS": ("agent", "delegate_toolsets"),
    "MARAS_SWITCHBOARD_HERMES_DELEGATE_USE_CONTEXT_FILES": ("agent", "delegate_use_context_files"),
    "MARAS_SWITCHBOARD_HERMES_DELEGATE_USE_MEMORY": ("agent", "delegate_use_memory"),
