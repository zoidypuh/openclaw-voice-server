...
from agent_switchboard.speak_paragraphs import DEFAULT_SPEAK_ENDPOINT, main, speak_paragraphs, split_paragraphs
...
def test_main_reads_stdin_and_uses_default_endpoint(monkeypatch, capsys):
    ...
    monkeypatch.setattr("agent_switchboard.speak_paragraphs.speak_paragraphs", fake_speak_paragraphs)
